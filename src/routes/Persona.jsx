      ...
      <div className="min-h-screen bg-gray-100 flex justify-center items-center">
        <div className="w- p-1 bg-white rounded-xl shadow-xl hover:shadow-2xl hover:scale-105 transition-all transform duration-500">
          ...
          <div className="mt-4">
            ...
            <p className="text-sm mt- text-gray-700"></p>
            <div className="mt-3 space-x-4 flex p-1">
            <div className="p-1 border-4 rounded-full cursor-pointer hover:border-grey-200  hover:scale-105 transition transform duration-200">
                <span className="block h-6 w-6 bg-purple-400 -400 rounded-full"> </span>
              </div>
              <div className="p-1 border-4 rounded-full cursor-pointer hover:border-grey-200  hover:scale-105 transition transform duration-200">
                <span className="block h-6 w-6 bg-purple-400 -400 rounded-full"> </span>
              </div>
            ...
            <div className="mt-4 mb-2 flex justify-between pl-4 pr-2">
              ...
              <button className="text-lg block font-semibold py-2 px-6 text-green-100 hover:text-white bg-indigo-400 rounded-lg shadow hover:shadow-md transition duration-300">
